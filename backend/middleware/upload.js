...
const fileFilter = (req, file, cb) => {
  ...
  // If the extension is in our list, we allow it regardless of the mimetype
  // This is safer because mimetypes vary by browser
  if (allowedExtensions.includes(fileExt)) {
    cb(null, true);
  } else {
    cb(new Error(`Invalid file type (${fileExt}). Only PDF, DOC, ZIP, IMAGES, and code files are allowed.`), false);
  }
};
const upload = multer({
  storage,
