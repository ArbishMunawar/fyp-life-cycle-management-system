...
const StudentDashboard = () => {
  ...
  // }, [dispatch]);
// This is already correct — but add a polling interval so it catches updates:
useEffect(() => {
  dispatch(fetchDashboardStats());
  ...
  const feedbackList =
    dashboardStats?.topNotifications
      ?.filter((n) => n.message?.toLowerCase().includes("feedback"))
      ?.slice(-2)
      .reverse() || [];
  ...
  return (
    <>
      <div className="space-y-6">
        {/* Header Section from image_559702.png */}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <div className="card">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                ...
                <p className="text-lg font-semibold text-slate-800">
                  {supervisorName} {/* Use the variable defined at the top */}
                </p>
              </div>
            </div>
          </div>
          {/* Next Deadline Card from image_559384.png */}
          <div className="card">
            <div className="flex items-center">
              <div className="p-3 bg-blue-100 rounded-lg">⏰</div>
              <div className="ml-4">
          ...
          {/* Recent Feedback Card from image_55935e.png */}
          <div className="card">
            <div className="flex items-center">
              <div className="p-3 bg-blue-100 rounded-lg">💬</div>
              <div className="ml-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="card">
            ...
            <div className="space-y-4">
              {/* Title Section - from image_55889a.png */}
              <div>
              ...
              {/* Description Section - from image_55855a.png */}
              <div>
                <label className="text-sm font-medium text-slate-600">
                  Description
                </label>
